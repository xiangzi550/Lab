  ...
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm
          ...
          @confirm="delBatch"
      >
        <el-button type="danger" slot="reference">批量恢复 <i class="el-icon-refresh-right"></i></el-button>
      </el-popconfirm>
...
<!--          <el-button type="success" @click="handleEdit(scope.row)">编辑 <i class="el-icon-edit"></i></el-button>-->
          ...
          >
            <el-button type="danger" slot="reference" >恢复 <i class="el-icon-refresh-right"></i></el-button>
          </el-popconfirm>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods:{
    ...
    save(){
      this.request.post("/usered",this.form).then(res=>{
        if(res) {
    ...
    //*恢复数据
    del(username){
      this.request.delete("/usered/"+username).then(res=>{
        if(res){
    ...
    delBatch(){
      ...
      this.request.post("/usered/del/batch",usernames).then(res=>{
        if(res){
